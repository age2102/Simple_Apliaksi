					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?= isset($data['nama_siswa']) ? htmlspecialchars($data['nama_siswa']) : 'Pelajar yang berbakat'; ?></b></h5>
							</div>	
						</div>
					</div>
				</div>
							...
							<div class="card full-height">
								<div class="card-body">
										...
										<center>
											...
											<br>
											<b>SMP NEGERI 1 MUHAMMADIYAH</b>
										</center>
									</div>
									<div class="card-category">
										<center>
jl. Jayaabadi - Pucakwangi Km 12 Kec. Bujung Kab. Bekasi Kode Pos 17330
<br>Email : smpn1negrimuhammadiyah@gmail.com Telp.081222333444
										</center>
									</div>
